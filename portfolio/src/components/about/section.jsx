        ...
        <section className={`${
            ...
            <div className="flex gap-[52px] max-lg:flex-col max-lg:items-start justify- items-center">
                ...
                <div className="flex flex-col gap-[12px] ">
                    ...
                    <div className="flex items-end gap-[12px] ">
                    <h1 className="text-[30px] max-[450px]:text-[24px] leading-[120%] font-bold ">DOM:</h1>
                    <p className="text-[24px] leading-[120%] italic "> 03/03/1999</p>
                    </div>
                    <div className="flex items-end max-[450px]:w-[90%] gap-[12px] ">
                    <h1 className="text-[30px] max-[450px]:text-[24px] leading-[120%] font-bold ">Highest Qualification:</h1>
                    <p className="text-[24px] max-[480px]:text-[20px] leading-[120%] italic "> M.M.S./BCA</p>
                    </div>
                    <div className="flex items-end gap-[12px] ">
                    <h1 className="text-[30px] max-[450px]:text-[24px] leading-[120%] font-bold ">Passed out Year:</h1>
                    <p className="text-[24px] leading-[120%] italic "> 2021</p>
                    </div>
                    <div className="flex items-end gap-[12px] ">
                    <h1 className="text-[30px] max-[450px]:text-[24px] leading-[120%] font-bold ">Experiance:</h1>
                    <p className="text-[24px] leading-[120%] italic "> Intern</p>
                    </div>
                    <div className="flex items-end gap-[12px] ">
                    <h1 className="text-[30px] max-[450px]:text-[24px] leading-[120%] font-bold ">Tech Stack:</h1>
